...
import static net.kehui.www.t_907_origin_V3.ui.KBubbleSeekBar32.TextPosition.BELOW_SECTION_MARK;
import static net.kehui.www.t_907_origin_V3.ui.KBubbleSeekBar32.TextPosition.BOTTOM_SIDES;
import static net.kehui.www.t_907_origin_V3.ui.KBubbleSeekBar32.TextPosition.SIDES;
 ...
 */
public class KBubbleSeekBar32 extends View {
    ...
    public KBubbleSeekBar32(Context context) {
        this(context, null);
    }

    public KBubbleSeekBar32(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public KBubbleSeekBar32(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        }
    ...
    private void autoAdjustSection() {
        ...
        if (!onSection) {
            ...
            valueAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    if (mProgressListener != null) {
                        mProgressListener.onProgressChanged(KBubbleSeekBar32.this, getProgress(),
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mProgressListener != null) {
                    mProgressListener.getProgressOnFinally(KBubbleSeekBar32.this, getProgress(),
                        getProgressFloat(), true);
                }
            }
    ...
    public interface OnProgressChangedListener {
        ...
        void onProgressChanged(KBubbleSeekBar32 bubbleSeekBar, int progress, float progressFloat, boolean fromUser);

        void getProgressOnActionUp(KBubbleSeekBar32 bubbleSeekBar, int progress, float progressFloat);

        void getProgressOnFinally(KBubbleSeekBar32 bubbleSeekBar, int progress, float progressFloat, boolean fromUser);
    }
