 ...
 */
public class KBubbleSeekBar12 extends View {
    ...
    public KBubbleSeekBar12(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public KBubbleSeekBar12(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMax = ta.getFloat(R.styleable.KBubbleSeekBar32_bsb_max, 12.0f);    //时间档位  //GC20220428
        ...
        //滑轨大小  dp2px(2)
        mTrackSize = ta.getDimensionPixelSize(R.styleable.KBubbleSeekBar32_bsb_track_size, dp2px(20));  //滑轨窄一些旧28 //GC20220928
        ...
        //切分的份数 10
        mSectionCount = ta.getInteger(R.styleable.KBubbleSeekBar32_bsb_section_count, 12);  //GC20220927 改为step点击,切割的份数改为12
        //滑轨底色  colorPrimary
...
//        }
    ...
    private void autoAdjustSection() {
        ...
        if (!onSection) {
            ...
            valueAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    if (mProgressListener != null) {
                        mProgressListener.onProgressChanged(KBubbleSeekBar12.this, getProgress(),
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mProgressListener != null) {
                    mProgressListener.getProgressOnFinally(KBubbleSeekBar12.this, getProgress(),
                        getProgressFloat(), true);
                }
            }
    ...
    public interface OnProgressChangedListener {
        ...
        void onProgressChanged(KBubbleSeekBar12 bubbleSeekBar, int progress, float progressFloat, boolean fromUser);

        void getProgressOnActionUp(KBubbleSeekBar12 bubbleSeekBar, int progress, float progressFloat);

        void getProgressOnFinally(KBubbleSeekBar12 bubbleSeekBar, int progress, float progressFloat, boolean fromUser);
    }
