...
import static net.kehui.www.t_907_origin_V3.ui.KBubbleSeekBar16.TextPosition.BELOW_SECTION_MARK;
import static net.kehui.www.t_907_origin_V3.ui.KBubbleSeekBar16.TextPosition.BOTTOM_SIDES;
import static net.kehui.www.t_907_origin_V3.ui.KBubbleSeekBar16.TextPosition.SIDES;
import static net.kehui.www.t_907_origin_V3.ui.KBubbleUtils.dp2px;
import static net.kehui.www.t_907_origin_V3.ui.KBubbleUtils.sp2px;
 ...
 * BubbleSeekBar Created by woxingxiao on 2016-10-27.   //GC20220413
 */
public class KBubbleSeekBar16 extends View {
    ...
    public KBubbleSeekBar16(Context context) {
        this(context, null);
    }

    public KBubbleSeekBar16(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public KBubbleSeekBar16(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMax = ta.getFloat(R.styleable.KBubbleSeekBar32_bsb_max, 16.0f);    //16kV电压档位  //GC20211227
        ...
        //滑轨大小  dp2px(2)
        mTrackSize = ta.getDimensionPixelSize(R.styleable.KBubbleSeekBar32_bsb_track_size, dp2px(32));  //滑轨窄一些旧28 //GC20220928
        ...
        //切分的份数 10
        mSectionCount = ta.getInteger(R.styleable.KBubbleSeekBar32_bsb_section_count, 4);   //GC20220927 改为step点击,切割的份数改为4
        //滑轨底色  colorPrimary
        ...
        int duration = ta.getInteger(R.styleable.KBubbleSeekBar32_bsb_anim_duration, -1);
        mAnimDuration = duration < 0 ? 200 : duration;
        //点击滑轨任意位置可变换   false
        isTouchToSeek = ta.getBoolean(R.styleable.KBubbleSeekBar32_bsb_touch_to_seek, true);
        ...
        //渐变范围  #ff46e880_#ffe1992e_#ffd44720
        String colorStr = ta.getString(R.styleable.KBubbleSeekBar32_bsb_colors);
        if (colorStr == null || colorStr.equals("")) {
            colorStr = "#ffEEEE00_#ffe1992e_#CD0000";
        }
        parseStringToLayerColors(colorStr);
        setEnabled(ta.getBoolean(R.styleable.KBubbleSeekBar32_android_enabled, isEnabled()));
        ta.recycle();
...
//        }
    ...
    private void autoAdjustSection() {
        ...
        if (!onSection) {
            ...
            valueAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    if (mProgressListener != null) {
                        mProgressListener.onProgressChanged(KBubbleSeekBar16.this, getProgress(),
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mProgressListener != null) {
                    mProgressListener.getProgressOnFinally(KBubbleSeekBar16.this, getProgress(),
                        getProgressFloat(), true);
                }
            }
    ...
    public interface OnProgressChangedListener {
        ...
        void onProgressChanged(KBubbleSeekBar16 bubbleSeekBar, int progress, float progressFloat, boolean fromUser);

        void getProgressOnActionUp(KBubbleSeekBar16 bubbleSeekBar, int progress, float progressFloat);

        void getProgressOnFinally(KBubbleSeekBar16 bubbleSeekBar, int progress, float progressFloat, boolean fromUser);
    }
