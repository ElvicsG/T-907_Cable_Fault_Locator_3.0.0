...
public class KBubbleConfigBuilder {
    ...
    private KBubbleSeekBar32 mBubbleSeekBar;

    KBubbleConfigBuilder(KBubbleSeekBar32 bubbleSeekBar) {
    ...
    public KBubbleConfigBuilder sectionTextPosition(@KBubbleSeekBar32.TextPosition int position) {
